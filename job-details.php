...
if(isset($_POST ['jobapply'])){
     if((isset($_GET ['id'])) && (isset($_GET ['company']))){
          ...
          $query="SELECT * FROM jobs WHERE ID='$id' AND JOB_TITLE='$company'";
          ...
          if($result->num_rows>0){
               ...
               VALUES('$myemail','$compemail','$company','$coun','$company')";
               $result = $conn->query($query);
...
<div class="container">  
     ...
     <section>
          ...
          if((isset($_GET ['id'])) && (isset($_GET ['company']))){
               ...
               $query="SELECT * FROM jobs WHERE ID='$id' AND JOB_TITLE='$comp'";
               $result= $conn->query($query);
               if($result->num_rows >0){
                    while($row = $result->fetch_assoc()) {
                         ?>
          <div class="container">
               <div class="row">
                    <div class="col-lg-3 col-md-3 col-xs-12">
                         <div>
                              ...
                              <img src="<?php echo $row['PHOTO']; ?>" alt="" class="img-responsive wc-image" height=150px width=150px>

                              <br>
                         </div>
                    </div>

                    <div class="col-lg-9 col-md-9 col-xs-12" style="color:white;">
                         <form action="#" method="post" class="form" style="padding-left:10px;">
                              <h2><?php echo $row['JOB_TITLE']; ?></h2>

                              <p class="lead"><strong class="text-primary"><?php echo $row['PAY']; ?></strong> <small> per year</small></p>

                              <p class="lead">
                                   <i class="fa fa-briefcase"></i> <?php echo $row['CATEGORY']; ?> &nbsp;&nbsp;
                                   <i class="fa fa-map-marker"></i> <?php echo $row['COUNTRY']; ?> &nbsp;&nbsp;
                                   <i class="fa fa-calendar"></i> <?php echo $row['DATE']; ?> &nbsp;&nbsp;<br>
               ...
               <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                         ...
                         <p>- MUST have qualified in <?php echo $row['REQUIREMENTS']; ?> </p>
                    </div>
               </div>
               ...
               <div class="panel panel-default">
                         ...
                         <div class="row">
                              ...
                              <div class="col-md-6">
                                   <p>
                                        ...
                                        <strong><?php echo $row['CONTACT_NAME']; ?></strong>
                                   </p>
                              </div>
                         </div>
                         ...
                         <div class="row">
                              ...
                              <div class="col-md-6">
                                   <p>
                                        ...
                                        <strong><a href="tel:456789123"><?php echo $row['MOBILE']; ?></a></strong>
                                   </p>
                              </div>
                         </div>
                         ...
                         <div class="row">
                              <div class="col-md-6">
                                   <p>
                                        ...
                                        <strong><a href="mailto:john@carsales.com"><?php echo $row['EMAIL']; ?></a></strong>
                                   </p>
                              </div>
                    ...
                    <form action="" method="POST"><button type="submit" name="jobapply">Apply</form>
               </div>
               <!--<div class="clearfix">
