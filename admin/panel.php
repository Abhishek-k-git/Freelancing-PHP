...
<html lang="en" dir="ltr">
  ...
  <body>
    <nav class="side_bar">
        ...
        <a href="form.php"><i class="fas fa-th" style="font-size:40px;margin-bottom:50px;margin-right:10px;color:white;"></i><span>Forms</span></a>
    ...
    <section class="section">
      <div class="left_div">
        ...
        <a href="form.php"><i class="fas fa-th"></i></a>
        <!--<a href="#"><i class="fas fa-info-circle"></a>-->
      ...
      <div class="right_div">
          <div class="right_body">
            <div class="card">
              <img src="img/jobs.jpeg" width=100% height=100%/>
              <h1>3</h1>
            ...
            <div class="card">
              <img src="img/jobs.jpeg" width=100%/>
              <h1>4</h1>
            <div class="card_container">
              <h4><b>Total</b></h4> 
              <p>Freelancers</p> 
